			...
			<DialogContent className="bg-white dark:bg-black">
				...
				{selectedUsers.length > 1 && (
					<>
						...
						/>
						<Button className='flex gap-2 cursor-pointer' onClick={() => imgRef.current?.click()}>
							<ImageIcon size={20} />
							Group Image
						</Button>
					</>
				...
				<div className='flex justify-between'>
					...
					<Button variant="default" className="bg-black text-white dark:bg-white dark:text-black cursor-pointer" onClick={handleCreateConversation}
